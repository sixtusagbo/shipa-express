    ...
    <div class="container-fluid overflow-hidden py-5 px-lg-0">
        <div class="container py-5 px-lg-0">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-4">
                    Edit Status for [{{ $status->shipment->tracking_number }}]
                </h1>
            </div>
                                ...
                                <div class="form-floating">
                                    <select class="form-control" id="stage" name="stage">
                                        ...
                                        @foreach (['Processing', 'Arrived', 'Departed', 'In Transit', 'Delivered', 'Returned', 'Cancelled'] as $stage)
                                            <option @if (old('stage', $status->stage) === $stage) selected @endif
                                                value="{{ $stage }}">
                                                {{ $stage }}
                                            </option>
                                        @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="location" placeholder="Location"
                                        name="location" value="{{ old('location', $status->location) }}">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="remarks" placeholder="Remarks"
                                        name="remarks" value="{{ old('remarks', $status->remarks) }}">
                            ...
                            <div class="col-12">
                                ...
                                <div class="border icon-input">
                                    <i class="fas fa-circle iconInputIcon @if ($status->icon_id == null) selected @endif"
                                        id="icon-input-null" onclick="selectIcon('null')"></i>
                                    @foreach ($icons as $icon)
                                        <i class="{{ $icon->name }} iconInputIcon @if ($status->icon_id == $icon->id) selected @endif"
                                            id="icon-input-{{ $icon->id }}"
